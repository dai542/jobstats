...
CLUSTER_TRANS = {"djhpc-polyu":"djhpc-polyu"}
...
note = ("This job did not use the GPU. Please resolve this " \
        ...
        "https://bquhgmffkaj.feishu.cn/docx/SSftdMvXgoGRc8x2Puqcbz3ynDe?from=from_copylink")
style = "bold-red"
